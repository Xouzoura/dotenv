return {
    ...
    },
    {
        ...
        config = function(_, opts)
            ...
            vim.keymap.set('n', '<leader>dr', function() require('dap').continue() end, {desc="Continue"})
            vim.keymap.set('n', '<leader>dl', function() require('dap').run_last() end, {desc="Run Last"})
            vim.keymap.set('n', '<leader>dw', function() require('dap').restart() end, {desc="Restart"})
            vim.keymap.set('n', '<leader>dt', function() require('dap').terminate() end, {desc="Terminate"})
            -- Redone with the F keys
            vim.keymap.set('n', '<F5>', function() require('dap').continue() end, {desc="Continue"})
            vim.keymap.set('n', '<F6>', function() require('dap').run_last() end, {desc="Run Last"})
            vim.keymap.set('n', '<F9>', function() require('dap').restart() end, {desc="Restart"})
            vim.keymap.set('n', '<F2>', function() require('dap').terminate() end, {desc="Terminate"})
            -- Continue
